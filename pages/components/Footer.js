      ...
      <div className="container mx-auto px-4 mb-12 md:mb-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col justify-start md:flex-row md:justify-between">
            ...
            >
              <h1 className="font-heading text-5xl sm:text-6xl  text-white mb-10 font-lobster">
                <span>Studio37</span>
            ...
            <div id="container" className="flex flex-col space-y-5 md:flex-row md:space-x-10 md:space-y-0">

              <div id="footer-location" className="flex flex-col md:pr-9">
              ...
              <div id="footer-contact" className="flex flex-col ">
                <div className="flex flex-row">
                  <span className="font-bold text-lg text-white tracking-widest">
                    CONTACT
                  </span>
              ...
              <div id="footer-socials" className="flex flex-col space-y-2 ">
                <div id="socials-header" className="flex flex-row ">
                  <span className="text-white font-bold text-lg tracking-widest">
                    SOCIALS
                  </span>
                </div>
                <div id="socials-icons-container" className="flex flex-row">
                  <a
                    className="flex justify-start items-center  mr-4 rounded-full"
                    href="#"
                  >
                    <svg
