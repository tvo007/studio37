...
const Hero = () => {
  return (
    <section className="bg-gray-800 overflow-hidden h-[100vh] relative">
      ...
      <div>
        <div className="w-full opacity-50 -z-20">
          <Image
            ...
            alt=""
            src={'https://res.cloudinary.com/ddj5orpun/image/upload/v1656219376/Studio37/R62G0049_cswvda.jpg'}
            layout="fill"
          />
        </div>
      </div>
      ...
      <nav className="h-10">
        <div>
          <ul className="flex flex-row justify-end items-end text-white brightness-100 space-x-10 pr-40 pt-5">
            <li>Home</li>
            <li>About</li>
            <li>Contact</li>
          </ul>
